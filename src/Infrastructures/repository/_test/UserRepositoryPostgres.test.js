...
describe('UserRepositoryPostgres', () => {
  it('should be instance of UserRepository domain', () => {
    ...
    expect(userRepositoryPostgres).toBeInstanceOf(UserRepositoryPostgres);
  });
  ...
  describe('behavior test', () => {
    ...
    describe('getIdByUsername', () => {
      it('should throw InvariantError when user not found', () => {
        ...
        // Action & Assert
        return expect(userRepositoryPostgres.getIdByUsername('dicoding'))
          .rejects
          .toThrowError(InvariantError);
      });
      ...
      it('should return username id when user is found', async () => {
        ...
        const userRepositoryPostgres = new UserRepositoryPostgres(pool, {});
        await UsersTableTestHelper.addUser({
          id: 'user-123', username: 'dicoding', fullname: 'Dicoding Indonesia',
        });
    ...
    describe('getOwnProfile', () => {
      it('should throw InvariantError when user not found', () => {
        ...
        // Action & Assert
        return expect(userRepositoryPostgres.getOwnProfile('user-123'))
          .rejects
          .toThrowError(InvariantError);
      });
      ...
      it('should return user profile when user is found', async () => {
        // Arrange
        const userRepositoryPostgres = new UserRepositoryPostgres(pool, {});
        await UsersTableTestHelper.addUser({ id: 'user-123', username: 'dicoding', fullname: 'Dicoding Indonesia' });

        // Action
        const profile = await userRepositoryPostgres.getOwnProfile('user-123');
    ...
    describe('getAllUsers', () => {
      it('should return all users', async () => {
        // Arrange
        await UsersTableTestHelper.addUser({ id: 'user-123', username: 'dicoding', fullname: 'Dicoding Indonesia' });
        await UsersTableTestHelper.addUser({ id: 'user-456', username: 'dicoding2', fullname: 'Dicoding Indonesia 2' });
