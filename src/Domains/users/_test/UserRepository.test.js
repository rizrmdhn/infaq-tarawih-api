...
describe('UserRepository interface', () => {
    it('should throw error when invoke abstract behavior', async () => {
        ...
        await expect(userRepository.getOwnProfile('')).rejects.toThrowError('USER_REPOSITORY.METHOD_NOT_IMPLEMENTED');
        await expect(userRepository.getAllUsers()).rejects.toThrowError('USER_REPOSITORY.METHOD_NOT_IMPLEMENTED');
    });
});